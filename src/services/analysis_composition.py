...
def create_analysis_components(
    settings: Settings,
    *,
    player_detector_logger: logging.Logger,
    ball_detector_logger: logging.Logger,
    ...
    tracker = tracker_override or DetectionOnlyPlayerTracker(
        YOLOPlayerDetector(settings, player_detector_logger),
        tracker_factory,
        settings,
        YOLOBallDetector(settings, ball_detector_logger),
    )
